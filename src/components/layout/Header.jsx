...
const Header = ({ currentUser, onLogin, onLogout, darkMode, onToggleDarkMode }) => {
  const currentOrganization = OrganizationManager.getCurrentOrganization();
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                {currentOrganization?.display_name || "Coinmate"}
              </h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            {currentUser && <OrganizationSelector currentUser={currentUser} />}
